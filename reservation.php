	...
	body{background-image:url(images/hotel10.jpg)}
	 ...
	 <div class="hotel_reserve_box">
         ...
         <form action="insert.php" method="POST">
             ...
             <div class="form-group">
                 <td><input type="submit"  value="Submit" style="background-color: #012A52;color: #fff;padding: 6px 70px;font-weight: 600;font-size: 18px; margin-left: 10px;border-radius: 5px;"></td>
             </div>
